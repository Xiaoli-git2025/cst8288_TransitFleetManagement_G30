<%-- 
    Document   : AddRoute
    Created on : Aug 1, 2025, 9:45:04 a.m.
    Author     : shan cai
--%>
...
<html>
    <head>
        ...
        <title>JTransit Fleet Management System - Route</title>
    </head>
    <body class="body">
        <!-- Header -->
        <div class="header">
        ...
        <div class="main">
            ...
            <div class="container">
                <div class="box">
                    <form action="${pageContext.request.contextPath}/RouteControl" method="post">
                        ...
                        <button type="submit" name="action" value="AddRoute" class="btn btn-sm btn-primary">Add Route</button>
                    </form>
                </div>
            </div>
    </body>
