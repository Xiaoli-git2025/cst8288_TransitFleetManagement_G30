<%-- 
    Document   : StationView
    Created on : Aug 1, 2025, 11:24:03 a.m.
    Author     : shan cai
--%>

<%@page import="business.StationBusinessLogic"%>
<%@page import="java.util.List" %>
<%@page import="model.StationDTO" %>
<%@page contentType="text/html;charset=UTF-8" language="java" %>
<%
    List<StationDTO> stations = (List<StationDTO>) request.getAttribute("stations");
%>
...
<html>
    <head>
        ...
        <title>Transit Fleet Management System - Station</title>
    </head>
    <body class="body">
        <!-- Header -->
        <div class="header">
            <h1>Admin - Station Management</h1>
            ...
            <div class="container">
                <div class="box_with_menu">
                    <div style="text-align:right; margin-bottom:1rem;">
                        <a href="${pageContext.request.contextPath}/views/admin/AddStation.jsp"
                           class="btn btn-outline-primary">Add Station</a>
                    </div>
