<%-- 
    ...
    Created on : Aug 1, 2025, 2:08:48 p.m.
    Author     : shan cai
--%>
                    ...
                    <form action="${pageContext.request.contextPath}/RouteScheduleControl" method="post">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="schedule_number" required></td>
                            </tr>
                            <tr>
                                <td>Arrive Time:</td>
                        ...
                        <button type="submit" name="action" value="AddRouteSchedule" class="btn btn-sm btn-primary">Add Route Schedule</button>
                    </form>
                </div>
            </div>
    </body>
