            ...
            <div class="container">
                <div class="box_with_menu">
                    <form method="post" action="${pageContext.request.contextPath}/ActiveMaintenanceAlert">
                        <%
                            List<FuelConsumptionDTO> fuels = (List<FuelConsumptionDTO>) request.getAttribute("fuel_consumption");
                        ...
                        <table border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><%= v_dao.getById(fuel.getVehicleId()).getVehicleNumber() %></td>
                                    <td><%= v_dao.getById(fuel.getVehicleId()).getFuelType() %></td>
                                    <td><%= fuel.getDate() %></td>
