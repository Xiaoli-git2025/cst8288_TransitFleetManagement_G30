                ...
                <%
                    if (logs != null && !logs.isEmpty()) {
                        for (OperatorPerformanceDTO log : logs) {
                            boolean arriveOnTime = log.getArriveTime() != null && log.getScheduleArriveTime() != null &&
                                !log.getArriveTime().after(log.getScheduleArriveTime());

                            boolean departOnTime = log.getDepartTime() != null && log.getScheduleDepartTime() != null &&
                                !log.getDepartTime().after(log.getScheduleDepartTime());
