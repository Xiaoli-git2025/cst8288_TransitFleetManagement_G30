<%-- 
    Document   : VehicleAlertView
    Created on : Aug 1, 2025, 10:04:13 p.m.
    Author     : shano
--%>
<%-- 
...
--%>
<%@page import="model.VehicleAlertDTO" %>
<%@page import="business.VehicleAlertBusinessLogic" %>
<%@page import="java.util.List" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%
    List<VehicleAlertDTO> alerts = (List<VehicleAlertDTO>) request.getAttribute("alerts");
...
<html>
    <head>
        ...
        <title>Transit Fleet Management System - Vehicle Alert</title>
    </head>
    <body class="body">
        <!-- Header -->
        <div class="header">
            <h1>Operator - Vehicle Alert</h1>
            ...
            <div class="container">
                <div class="box_with_menu">
                    <table border="1">
                        ...
                        <tbody>
                            <% for (VehicleAlertDTO alert : alerts) { 
